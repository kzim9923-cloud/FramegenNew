...
class SettingsDrawerOverlay(
    ...
    private fun buildPanel(): View {
        ...
        // ---- Auto bypass (backlog-pressure) --------------------------------------
        // OFF by default: the render loop only starts skipping frame-generation
        // automatically for backlog pressure once the user turns this on here.
        // This is separate from the manual "Bypass" toggle (raw passthrough) at
        // the top of this section — this only ever skips the OPTIONAL generation
        // step for individual frames while capture keeps flowing.
        frameGenSection.addView(sectionSpacer(8))
        frameGenSection.addView(miniHeader("Auto bypass"))
