...
object NativeBridge {
    ...
    external fun setFrameTransferMode(mode: Int)
    ...
    /**
     * Edge anti-aliasing applied to source samples before enhancement/upscale.
     * 0 = OFF, 1 = FXAA, 2 = SMAA (lightweight single-pass approximation — see
     * the native gpu_image_enhancement.cpp comment for why full multi-pass
     * SMAA isn't used). Persists across re-inits like the other live controls.
     */
    external fun setAntiAliasMode(mode: Int)
