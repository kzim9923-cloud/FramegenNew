...
data class LsfgConfig(
    ...
    val frameTransferMode: FrameTransferMode,
 ...
 */
enum class FrameTransferMode(val prefValue: String, val nativeValue: Int) {
    CPU_COPY("cpu_copy", 0),
    GPU_COPY("gpu_copy", 1),
    ZERO_COPY("zero_copy", 2);

    companion object {
        fun fromPref(value: String?): FrameTransferMode =
            values().firstOrNull { it.prefValue == value } ?: GPU_COPY
    }
}
...
class LsfgPreferences(ctx: Context) {
    ...
    fun load(): LsfgConfig = LsfgConfig(
        ...
        frameTransferMode = FrameTransferMode.fromPref(prefs.getString(KEY_FRAME_TRANSFER_MODE, null)),
    ...
    fun setFrameTransferMode(value: FrameTransferMode) = prefs.edit()
        .putString(KEY_FRAME_TRANSFER_MODE, value.prefValue).apply()
    ...
    companion object {
        ...
        private const val KEY_FRAME_TRANSFER_MODE = "frame_transfer_mode"
