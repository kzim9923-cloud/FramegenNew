        ...
        LsfgCard {
            ...
            if (state.captureSource == CaptureSource.MEDIA_PROJECTION) {
                ...
                ToggleRow(
                    ...
                    title = "การจับภาพแบบดีเลย์ต่ำ",
                    description = "คิวการจับภาพตื้นกว่าเดิม จะตัดไปใช้เฟรมล่าสุดเสมอแทนการประมวลผลทุกเฟรมที่ค้างอยู่ ลดดีเลย์จากการจับภาพจนถึงการส่งออก แต่อาจเพิ่มการบิดเบือนภาพระหว่างเคลื่อนไหวเร็ว (ใช้ได้เฉพาะการจับภาพแบบ MediaProjection)",
