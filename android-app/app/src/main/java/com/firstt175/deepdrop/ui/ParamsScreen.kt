...
fun OverlayDisplayScreen(nav: NavHostController) {
    ...
    Column(
        ...
        // Live HUD preview uses the actual asset shipped in assets/hud/1.png.
        // This is intentionally an image preview rather than another abstract toggle,
        // so the user can see what the selected HUD style looks like before starting.
        LsfgCard {
            SectionHeader(eyebrow = "LIVE HUD PREVIEW", title = null)
            ...
            Text(
                "นี่คือภาพ HUD จริงจาก assets/hud/1.png • เปิด/ปิด FPS, graph และ system stats แล้วผลจะแสดงใน session",
