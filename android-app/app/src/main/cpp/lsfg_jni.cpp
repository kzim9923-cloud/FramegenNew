...
extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setFrameSchedulingMode(
        JNIEnv * /*env*/, jobject /*thiz*/, jint mode) {
    lsfg_android::setFrameSchedulingMode(static_cast<int32_t>(mode));
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setDynamicBypassEnabled(
        JNIEnv * /*env*/, jobject /*thiz*/, jboolean enabled) {
    lsfg_android::setDynamicBypassEnabled(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setDynamicBypassBudgetMultiplier(
        JNIEnv * /*env*/, jobject /*thiz*/, jdouble multiplier) {
    lsfg_android::setDynamicBypassBudgetMultiplier(static_cast<double>(multiplier));
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_getDynamicBypassCount(
        JNIEnv * /*env*/, jobject /*thiz*/) {
    return static_cast<jlong>(lsfg_android::getDynamicBypassCount());
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setRealFrameFirstEnabled(
        JNIEnv * /*env*/, jobject /*thiz*/, jboolean enabled) {
    lsfg_android::setRealFrameFirstEnabled(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setPreflightSafetyWindowEnabled(
        JNIEnv * /*env*/, jobject /*thiz*/, jboolean enabled) {
    lsfg_android::setPreflightSafetyWindowEnabled(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setPreflightSafetyWindowRatio(
        JNIEnv * /*env*/, jobject /*thiz*/, jdouble ratio) {
    lsfg_android::setPreflightSafetyWindowRatio(static_cast<double>(ratio));
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setStaleDropLoggingEnabled(
        JNIEnv * /*env*/, jobject /*thiz*/, jboolean enabled) {
    lsfg_android::setStaleDropLoggingEnabled(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setStaleGenerationToleranceEnabled(
        JNIEnv * /*env*/, jobject /*thiz*/, jboolean enabled) {
    lsfg_android::setStaleGenerationToleranceEnabled(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setStaleGenerationToleranceEpochs(
        JNIEnv * /*env*/, jobject /*thiz*/, jint epochs) {
    lsfg_android::setStaleGenerationToleranceEpochs(static_cast<int>(epochs));
}
