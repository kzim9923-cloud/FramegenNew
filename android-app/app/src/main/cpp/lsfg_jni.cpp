...
Java_com_firstt175_deepdrop_session_NativeBridge_initContext(
        ...
        jint postProcessMode, jfloat postProcessSharpness,
        jint aiEngine) {
    const std::string cache = jstring_to_std(env, cacheDir);
    ...
    const lsfg_android::RenderLoopConfig cfg{
        ...
        .postProcessMode = static_cast<int>(postProcessMode),
        .postProcessSharpness = static_cast<float>(postProcessSharpness),
