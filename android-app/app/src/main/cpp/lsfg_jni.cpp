...
extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setFrameQueueCapacity(
        JNIEnv * /*env*/, jobject /*thiz*/, jint capacity) {
    lsfg_android::setFrameQueueCapacity(static_cast<int32_t>(capacity));
}

extern "C" JNIEXPORT jint JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_getFrameQueueCapacity(
        JNIEnv * /*env*/, jobject /*thiz*/) {
    return static_cast<jint>(lsfg_android::getFrameQueueCapacity());
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_getQueueOverflowDroppedCount(
        JNIEnv * /*env*/, jobject /*thiz*/) {
    return static_cast<jlong>(lsfg_android::getQueueOverflowDroppedCount());
}
